            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <table
                        ...
                        <tbody>
                        <?php
                            $sql = "SELECT * FROM category ORDER BY cat_id ASC LIMIT ".$per_rows. ',' .$rows_per_page;
                            ...
                            while($row = mysqli_fetch_assoc($query)){ ?>
                                <tr>
                                    ...
                                    <td class="form-group">
                                        ...
                                        <a href="delete_category.php?cat_id=<?php echo $row['cat_id']?>" onclick="return deleteItem(<?php echo $row['cat_id'];?>)" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
                                    </td>
                                </tr>
                          <?php } ?>
                        </tbody>
...
<script>
    function deleteItem($id) {
        return confirm("Ban muon xoa danh muc " +$id + "?" );
    }
</script>