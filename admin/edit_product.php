...
$category = mysqli_query($connect, $sql_cat);
//Lay ra cac thuoc tinh cua san pham
if(isset($_POST['sbm'])){
    ...
    $sql_update = "UPDATE product SET prd_name='$prd_name', prd_price='$prd_price', prd_warranty='$prd_warranty', prd_accessories='$prd_accessories', prd_promotion='$prd_promotion',
            prd_new='$prd_new', prd_image='$prd_image', cat_id='$cat_id', prd_status='$prd_status', prd_featured='$prd_featured', prd_details='$prd_details' WHERE prd_id=$prd_id";
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <br>
                            <div>
                                <img src="img/products/<?php echo $row['prd_image']?>" style="width: 500px">
                            </div>
                        </div>
                        <div class="form-group">
